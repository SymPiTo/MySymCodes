 ...
 * @copyright     2017 Michael TrÃ¶ger
...
/**
 * Alle OpCodes fÃ¼r einen Websocket-Frame
 */
...
/**
 * Ein Frame fÃ¼r eine Websocket Verbindung.
 */
class WebSocketFrame extends stdClass
{
    ...
    /**
     * Erzeugt einen Frame anhand der Ã¼bergebenen Daten.
     *
     * @param object|string|null|WebSocketOPCode Aus den Ã¼bergeben Daten wird das Objekt erzeugt
    ...
    public function __construct($Frame = null, $Payload = null)
    {
        ...
        //PrÃ¼fen ob genug daten da sind !
    ...
    /**
     * Liefert den Byte-String fÃ¼r den Versand an den IO-Parent
     *
     */
...
/**
 * EnthÃ¤lt die Daten eines Client.
 */
class Websocket_Client
{
    ...
    /**
     * Letzer Zeitpunkt der DatenÃ¼bertragung.
     * @var Timestamp
     * @access public
     */
    public $Timestamp;
    ...
    /**
     * Erzeugt ein Websocket_Client-Objekt aus den Ã¼bergebenden Daten.
     *
     * @access public
...
/**
 * WebSocket_ClientList ist eine Klasse welche ein Array von Websocket_Clients enthÃ¤lt.
 *
 */
class WebSocket_ClientList
{
    ...
    /**
     * Update fÃ¼r einen Eintrag in $Items.
     * @access public
    ...
    /**
     * LÃ¶scht einen Eintrag aus $Items.
     * @access public
     * @param Websocket_Client $Client Der Index des zu lÃ¶schenden Items.
     */
     ...
     * @return Websocket_Client Der Client mit dem erstmÃ¶glichen Timeout.
     */
