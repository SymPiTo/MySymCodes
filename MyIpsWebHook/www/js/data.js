    ...
    class data { 
        ...
        getTVchannels(){
            var TVchannels = new Array (
                ...
                {  No: 19, selected: false,   Sender: "ServusTV HD",   icon: "ServusTV HD.png" }, 
                {  No: 20, selected: false,   Sender: "WDR Köln",   icon: "WDR Köln.png" },  
                {  No: 21, selected: false,   Sender: "hr-fernsehen HD",   icon: "hr-fernsehen HD.png" },  
